...
{{--                                @endif--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="drive_video" name="drive_video" rows="3" required>{{ old('drive_video') }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="expiry_days" name="expiry_days" value="{{ old('expiry_days') }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="number_of_codes">Number of codes</label>
                                    <input type="number" class="form-control" id="number_of_codes" value="{{ old('number_of_codes') }}" name="number_of_codes" required>
                                </div>
